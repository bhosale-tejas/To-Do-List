...
document.addEventListener("DOMContentLoaded", () => {
        ...
        const handleSearch = () => {
            ...
            if (searchText !== "") {
                ...
                if (filteredTasks.length === 0) {
                    // If no tasks match the search criteria, show an alert
                    swal(
                        "Task not found!",
    ...
    logoutLink.addEventListener("click", () => {
        swal({
            title: "Are you sure?",
            text: "Logging out will delete your profile name, email, and photo.",
            icon: "warning",
    ...
    function getUserPreferences() {
        ...
        const defaultPreferences = {
            ...
            photo: "img/profile.png" // Default photo
        };
    ...
    function setUserPreferences(name, email, photo) {
        const preferences = { name, email, photo };
        localStorage.setItem("userPreferences", JSON.stringify(preferences));
    }

    // Function to prompt the user for their name, email, and photo using SweetAlert
    function promptForNameEmailAndPhoto() {
        swal({
            ...
            content: {
                ...
                attributes: {
                    ...
                    <div class="form__group field">
                        <input type="file" class="form__field" id="swal-input-photo" accept="image/*" required="">
                        <label for="swal-input-photo" class="form__label">Photo</label>
                    </div>
                    `,
                },
            },
            ...
            if (result && result.dismiss !== "cancel") {
                ...
                const photo = document.getElementById("swal-input-photo").files[0];
                ...
                reader.onload = () => {
                    const finalPhoto = reader.result || "img/profile.png"; // Default photo if there's an error reading the file

                    setUserPreferences(finalName, finalEmail, finalPhoto);
                    displayProfileData(finalName, finalEmail, finalPhoto);
                };
            }
        });
    }
    ...
    function displayProfileData(name, email, photo) {
        const nameElement = document.getElementById("name");
        const emailElement = document.getElementById("email");
        const photoElement = document.getElementById("profileImg");
    ...
    if (
        ...
        preferences.photo === "img/profile.png"
    ) {
        // If preferences are default, prompt the user for their name, email, and photo
        promptForNameEmailAndPhoto();
    } else {
        // If preferences are already set, display them
        displayProfileData(preferences.name, preferences.email, preferences.photo);
    }
